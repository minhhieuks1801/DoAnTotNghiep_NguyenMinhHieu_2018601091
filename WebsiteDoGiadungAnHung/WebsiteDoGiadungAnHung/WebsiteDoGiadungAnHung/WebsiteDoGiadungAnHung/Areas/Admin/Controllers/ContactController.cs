...
namespace WebsiteDoGiaDungAnHung.Areas.Admin.Controllers
{
    public class ContactController : BaseController
    {
        ...
        public ActionResult Reply(MContact mContact, String Email/*, String Phone*/)
        {
            if (ModelState.IsValid)
            {
                ...
                helperV.SendMail(Email, "Thông báo", "Admin AnHungShop sẽ liên hệ qua SĐT: 0" + /*Phone +*/ "trong thời gian sớm nhất! ");
                Notification.set_flash("Đã trả lời liên hệ!", "success");
                return RedirectToAction("Index");
            }
            return View(mContact);
