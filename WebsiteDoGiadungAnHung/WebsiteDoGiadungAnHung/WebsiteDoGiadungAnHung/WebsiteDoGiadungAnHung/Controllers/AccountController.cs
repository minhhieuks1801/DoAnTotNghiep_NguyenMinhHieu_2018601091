...
using WebsiteDoGiaDungAnHung.Models;
using WebsiteDoGiaDungAnHung.Library;
using System.Net.Mail;
using System.Net;

namespace WebsiteDoGiaDungAnHung.Controllers
{
    public class AccountController : Controller
    {
        ...
        public void SendVerificationLinkEmail(string emailID, string activationCode, string emailFor = "VerifyAccount")
        {
            ...
            var fromEmail = new MailAddress("minhhieu2000dh@gmail.com", "Shinita@18");
            var toEmail = new MailAddress(emailID);
            var fromEmailPassword = "ahpocskwlowxztsg"; // Replace with actual password

            string subject = " ";
            string body = " ";
            if (emailFor == "VerifyAccount")
            {
                subject = "Tài khoản của bạn đã được tạo thành công tại AnHungShop!";
                body = "<br/><br/>AnHungShop rất vui khi được thông báo với bạn rằng tài khoản AnHungShop của bạn là" +
            ...
            else if (emailFor == "ResetPassword")
            {
                ...
                body = "Xin chào,<br/><br/>AnHungShop đã nhận được yêu cầu đặt lại mật khẩu tài khoản của bạn. Vui lòng nhấp vào liên kết dưới đây để đặt lại mật khẩu của bạn" +
        ...
        public ActionResult ForgotPassword(string EmailID)
        {
            ...
            using (ConnectDbContext dc = new ConnectDbContext())
            {
                ...
                if (account != null)
                {
                    ...
                    dc.SaveChanges();
                    Notification.set_flash("AnHungShop đã gửi liên kết đặt lại mật khẩu đã được gửi đến email của bạn!", "success");               

                }
                else
                {
                    //ViewBag.message = "Gmail không tồn tại trong hệ thống!";
                    Notification.set_flash("Gmail không tồn tại trong hệ thống!", "success");
                }
