...
using WebsiteDoGiaDungAnHung.MomoAPI;
...
namespace WebsiteDoGiaDungAnHung.Controllers
{
    public class CartController : Controller
    {
        ...
        public JsonResult Payment(String Address, String FullName, String Phone, String Email, String CodeVoucher)
        {
            ...
            "[AnHungShop] THÔNG BÁO XÁC NHẬN ĐƠN HÀNG",
                            "Xin chào"
                            +
                            orderV.DeliveryName
                            +
                            "AnHungShop vừa nhận được đơn đặt hàng từ bạn, "
                            +
        ...
        public ActionResult CancelOrder(int id)
        {
            ...
            db.SaveChanges();
            MailHelper helper = new MailHelper();
            helper.SendMail(obj.DeliveryEmail, "[AnHungShop] THÔNG BÁO HỦY ĐƠN HÀNG", "Hủy đơn hàng thành công");
